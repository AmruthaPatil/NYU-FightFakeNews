...
def init_spark():
    ...
    # Tokenize text data
    loadedcvmodel = CountVectorizerModel.load("/temp/my_vectorizer_model3")

    # Load the trained model from disk
    rfcmodel = RandomForestClassificationModel.load("/temp/RFC_small5_Model.mdl")

    #TO RUN THE BIG MODEL
    # rfcmodel = RandomForestClassificationModel.load("/RFCModel.mdl")
...
def main():
    ...
    pandas_df = sqlc.read.option("multiline",True).option("mode", "DROPMALFORMED").csv("/part-00000-06329a45-648b-4df7-b48c-f1ed06fea5fa-c000.csv").toPandas()
